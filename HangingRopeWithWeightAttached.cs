...
namespace Adventure
{
    public class HangingRopeWithWeightAttached : Rope
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (weight.animatedSprite.CurrentFrameIndex != weight.previousFrameNumber)
            {
                weight.UpdateGunlineHitboxes();
                weight.previousFrameNumber = weight.animatedSprite.CurrentFrameIndex;
            }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            weight.animatedSprite.Render(spriteBatch);
