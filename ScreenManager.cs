...
namespace Adventure
{
    public class ScreenManager
    {
        ...
        public void CreateScreens(ContentManager content)
        {
            ...
            {
                new Door(new Vector2(8 * 21 + 4, 8 * 18), "Door", 2, 1)
            };
            ...
            List<GameObject> screen2GameObjects = new List<GameObject>()
            {
                ...
                new Door(new Vector2(8 * 1, 8 * 18), "Door", 1, 1),
                new Door(new Vector2(8 * 22, 8 * 15), "Door", 3, 1)
            };

            for (int i = 5; i < 40; i++)
            {
                screen2GameObjects.Add(new Spike(new Vector2(8 * i, 21 * 8), "Spike"));
            }
            ...
            List<GameObject> screen4GameObjects = new List<GameObject>()
            {
                ...
                new Ladder(new Vector2(8 * 11, 8 * 10), 11),
                new Door(new Vector2(8 * 5, 8 * 8), "Door", 3, 2),
                new Door(new Vector2(8 * 33, 8 * 14), "Door", 5, 1)
            ...
            {
                new Door(new Vector2(8 * 3, 8 * 18), "Door", 4, 2),
                new Door(new Vector2(8 * 25, 8 * 18), "Door", 6, 1),
            };
            ...
            {
                new Door(new Vector2(8 * 3, 8 * 18), "Door", 5, 2),
                new Door(new Vector2(8 * 35, 8 * 18), "Door", 7, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 3, 8 * 18), "Door", 6, 2),
                new Door(new Vector2(8 * 35, 8 * 18), "Door", 8, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 3, 8 * 19), "Door", 7, 2),
                new Door(new Vector2(8 * 37, 8 * 3), "Door", 9, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 3, 8 * 18), "Door", 8, 2),
                new Door(new Vector2(8 * 35, 8 * 18), "Door", 10, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 18), "Door", 9, 2),
                new Door(new Vector2(8 * 37, 8 * 18), "Door", 11, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 10, 2),
                new Door(new Vector2(8 * 37, 8 * 13), "Door", 12, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 11, 2),
                new Door(new Vector2(8 * 37, 8 * 13), "Door", 13, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 18), "Door", 12, 2),
                new Door(new Vector2(8 * 36, 8 * 8), "Door", 14, 1),
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 18), "Door", 13, 2),
                new Door(new Vector2(8 * 37, 8 * 18), "Door", 15, 1),
            };
            ...
            {
                new Door(new Vector2(8 * 9, 8 * 18), "Door", 14, 2),
                new Door(new Vector2(8 * 37, 8 * 18), "Door", 16, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 15, 2),
                new Door(new Vector2(8 * 37, 8 * 13), "Door", 17, 1),
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 16, 2),
                new Door(new Vector2(8 * 37, 8 * 13), "Door", 18, 1),
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 19), "Door", 17, 2),
                new Door(new Vector2(8 * 37, 8 * 19), "Door", 19, 1),
                new GlobalTeleport(new Vector2(8 * 19, 8 *5), "RopeRing2")
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 1), "Door", 18, 2),
                new Door(new Vector2(8 * 37, 8 * 16), "Door", 20, 1),
            ...
            {
                new Door(new Vector2(8 * 2, 8 * 15), "Door", 19, 2),
                new Door(new Vector2(8 * 36, 8 * 15), "Door", 21, 1),
            ...
            {
                new Door(new Vector2(8 * 2, 8 * 15), "Door", 20, 2),
                new Door(new Vector2(8 * 37, 8 * 15), "Door", 22, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 12), "Door", 21, 2),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 12), "Door", 22, 2),
                new Door(new Vector2(8 * 37, 8 * 12), "Door", 24, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 12), "Door", 23, 2),
                new Door(new Vector2(8 * 37, 8 * 12), "Door", 25, 1),
                new FlashingBeam(new Vector2( 8 * 19, 8 * 3), 600, 10, 0, new Vector2( 8 * 19, 8 * 21)),
                new FlashingBeam(new Vector2( 8 * 20, 8 * 3), 600, 10, 0, new Vector2( 8 * 20, 8 * 21)),
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 18), "Door", 24, 2),
                new Door(new Vector2(8 * 36, 8 * 11), "Door", 26, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 10, 8 * 14), "Door", 25, 2),
                new Door(new Vector2(8 * 28, 8 * 14), "Door", 27, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 2), "Door", 26, 2),
                new Door(new Vector2(8 * 38, 8 * 2), "Door", 28, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 29, 2),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 9), "Door", 30, 2),
                new Door(new Vector2(8 * 118, 8 * 9), "Door", 32, 1),
            ...
            {
                new Door(new Vector2(8 * 1, 8 * 13), "Door", 31, 2),
                new Door(new Vector2(8 * 37, 8 * 6), "Door", 33, 1)
            };
            ...
            {
                new Door(new Vector2(8 * 0, 8 * 19), "Door", 32, 2),
                new Door(new Vector2(8 * 37, 8 * 3), "Door", 34, 1),
            ...
            Note screen33Note = new Note(new Vector2(8 * 3, 8 * 19), "FKeyRound", "F", screen33Platforms);
            ...
            {
                new Door(new Vector2(8 * 0, 8 * 19), "Door", 33, 2),
                new Door(new Vector2(8 * 37, 8 * 3), "Door", 35, 1),
            ...
            Note screen34Note = new Note(new Vector2(8 * 3, 8 * 19), "FKeyRound", "F", screen34Platforms);
            ...
            {
                new Door(new Vector2(8 * 0, 8 * 4), "Door", 34, 2),
                new Door(new Vector2(8 * 32, 8 * 18), "Door", 36, 1),
